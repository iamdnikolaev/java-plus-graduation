...
public class EventServiceImpl implements EventService {
     ...
     * @param userClient            the client of user service
     * @param requestClient         the client of request service
    ...
    public EventFullDto createEvent(Long userId, NewEventDto eventDto) {
        UserDto initializer = userClient.getUserById(userId);
    ...
    public List<EventShortDto> getEvents(String text, List<Long> categories, Boolean paid,
        ...
        for (Event event : events) {
            long confirmedRequests = requestClient.getRequestCountByStatusAndEventId(RequestStatus.CONFIRMED, event.getId());
    ...
    public EventFullDto getEventById(Long userId, Long eventId) {
        ...
        long confirmedRequests = requestClient.getRequestCountByStatusAndEventId(RequestStatus.CONFIRMED, eventId);
    ...
    @Override
    @Transactional(readOnly = true)
    public EventFullDto getEventByIdForAdmin(Long eventId) {
        Event event = eventRepository.findById(eventId).orElseThrow(
                () -> new NotFoundException("Event with id=" + eventId + " not found!", "")
        );
        EventFullDto eventFullDto = utilEventClass.toEventFullDto(event);
